...
describe('v1beta1.PrivateCatalogClient', () => {
    ...
    describe('searchCatalogs', () => {
        it('invokes searchCatalogs without error', async () => {
            ...
            assert((client.innerApiCalls.searchCatalogs as SinonStub)
        ...
        it('uses async iteration with searchCatalogs with error', async () => {
            ...
            const request = generateSampleMessage(new protos.google.cloud.privatecatalog.v1beta1.SearchCatalogsRequest());
            request.resource = '';
            const expectedHeaderRequestParams = "resource=";const expectedError = new Error('expected');
    ...
    describe('searchProducts', () => {
        it('invokes searchProducts without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchProducts as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('searchVersions', () => {
        it('invokes searchVersions without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchVersions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

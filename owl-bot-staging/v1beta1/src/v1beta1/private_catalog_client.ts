 ...
 * `src/v1beta1/private_catalog_client_config.json`.
 ...
 *
 *  `Catalog` is computed based on the {@link |Association}s linked to the target
 *  resource and its ancestors. Each association's
 *  {@link |google.cloud.privatecatalogproducer.v1beta.Catalog} is transformed into a
 *  `Catalog`. If multiple associations have the same parent
 *  {@link |google.cloud.privatecatalogproducer.v1beta.Catalog}, they are
...
export class PrivateCatalogClient {
  ...
  initialize() {
    ...
    if (this.privateCatalogStub) {
      return this.privateCatalogStub;
    }
 ...
 *   The first element of the array is Array of [Catalog]{@link google.cloud.privatecatalog.v1beta1.Catalog}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Catalog]{@link google.cloud.privatecatalog.v1beta1.Catalog} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [Catalog]{@link google.cloud.privatecatalog.v1beta1.Catalog}. The API will be called under the hood as needed, once per the page,
 ...
 *   The request object that will be sent.
 * @param {string} request.resource
 *   Required. The name of the resource context. See {@link google.cloud.privatecatalog.v1beta1.SearchCatalogsRequest.resource|SearchCatalogsRequest.resource}
 *   for details.
 * @param {string} request.query
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Product]{@link google.cloud.privatecatalog.v1beta1.Product}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Product]{@link google.cloud.privatecatalog.v1beta1.Product} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `searchProductsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
 *   When you iterate the returned iterable, each element will be an object representing
 *   [Product]{@link google.cloud.privatecatalog.v1beta1.Product}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [Version]{@link google.cloud.privatecatalog.v1beta1.Version}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [Version]{@link google.cloud.privatecatalog.v1beta1.Version} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `searchVersionsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
 *   When you iterate the returned iterable, each element will be an object representing
 *   [Version]{@link google.cloud.privatecatalog.v1beta1.Version}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 ...
 */
   ...
   * @returns {string} A string representing the catalog.
   */
  matchCatalogFromVersionName(versionName: string) {
    return this.pathTemplates.versionPathTemplate.match(versionName).catalog;
  }
   ...
   * @returns {string} A string representing the product.
   */
  matchProductFromVersionName(versionName: string) {
    return this.pathTemplates.versionPathTemplate.match(versionName).product;
  }
